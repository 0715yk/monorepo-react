...
__export(src_exports, {
  ...
  asyncSome: () => asyncSome,
  chain: () => chain,
  checkIntroductionLength: () => checkIntroductionLength,
  checkNicknameCharacter: () => checkNicknameCharacter,
  checkNicknameLength: () => checkNicknameLength,
  checkNicknameWhiteSpace: () => checkNicknameWhiteSpace,
  checkPasswordHasLowerCase: () => checkPasswordHasLowerCase,
  checkPasswordHasSpecificCharacters: () => checkPasswordHasSpecificCharacters,
  checkPasswordHasUpperCase: () => checkPasswordHasUpperCase,
  checkPasswordLength: () => checkPasswordLength,
  checkSpeicalCharacter: () => checkSpeicalCharacter,
  checkStringLength: () => checkStringLength,
  checkTagCharacter: () => checkTagCharacter,
  checkValidEmail: () => checkValidEmail,
  curry: () => curry,
  fork: () => fork,
  identity: () => identity,
  isEitherValid: () => isEitherValid,
  isValid: () => isValid,
  ...
  partial: () => partial,
  pipe: () => pipe,
  replaceAllBlack: () => replaceAllBlack,
  sequence: () => sequence,
  tap: () => tap,
...
var isValid = (value) => value !== void 0 && value !== null && value !== "";
var isEitherValid = (value) => value !== void 0 && value !== null && value !== "" ? Either.right(value) : Either.left("Invalid value");
var pipe = (...fns) => {
...
var Either = class _Either {
  ...
  static fromNullable(val) {
    return isValid(val) ? _Either.right(val) : _Either.left(val);
  }
  static of(a) {
    return _Either.right(a);
  }
};
...
var IO = class _IO {
  constructor(effect) {
    if (!import_lodash.default.isFunction(effect)) {
  ...
  map(fn) {
    let self2 = this;
    return new _IO(() => fn(self2.effect()));
  }
  chain(fn) {
...
var NICKNAME_CHARACTER_ERROR_MESSAGE = "\uB2C9\uB124\uC784\uC740 \uD2B9\uC218\uBB38\uC790\uB97C \uC81C\uC678\uD558\uACE0 \uC785\uB825\uD574\uC8FC\uC138\uC694.";
var NICKNAME_WHITESPACE_ERROR_MESSAGE = "\uB2C9\uB124\uC784\uC740 \uACF5\uBC31\uC744 \uC81C\uC678\uD558\uACE0 \uC785\uB825\uD574\uC8FC\uC138\uC694.";
var REGEX_WITHOUT_CHARACTERS = /^[ㄱ-ㅎ가-힣a-zA-Z0-9\s]*$/;
var REGEX_CHECK_BLANK = /^\S*$/;
var REGEX_EMAIL = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
var REGEX_TAG = /^[a-zA-Z0-9가-힣]{3,10}$/;
var REGEX_ALPHABET_UPPER_CASE = /[A-Z]/;
var REGEX_ALPHABET_LOWER_CASE = /[a-z]/;
var REGEX_SPECIFIC_CHARACTERS = /[!@#$%^&*(),.?":{}|<>]/;
var EMAIL_FORMAT_ERROR_MESSAGE = "\uC62C\uBC14\uB978 \uC774\uBA54\uC77C \uD615\uC2DD\uC774 \uC544\uB2D9\uB2C8\uB2E4.";
var PASSWORD_FORMAT_ERROR_MESSAGE = "\uBE44\uBC00\uBC88\uD638\uB294 \uC601\uBB38 \uB300\uC18C\uBB38\uC790\uC640 \uD2B9\uC218\uBB38\uC790\uB97C \uD3EC\uD568\uD574\uC57C \uD569\uB2C8\uB2E4";
var PASSWORD_LENGTH_ERROR_MESSAGE = "\uBE44\uBC00\uBC88\uD638\uB294 10\uAE00\uC790 \uC774\uC0C1 20\uAE00\uC790 \uC774\uD558\uB85C \uC785\uB825\uD574\uC8FC\uC138\uC694.";
var TAG_CHARACTER_ERROR_MESSAGE = "\uD0DC\uADF8\uB294 \uC601\uBB38, \uC22B\uC790, \uD55C\uAE00\uB9CC \uC0AC\uC6A9 \uAC00\uB2A5\uD569\uB2C8\uB2E4";
var INTRODUCTION_LENGTH_ERROR_MESSAGE = "\uC790\uAE30\uC18C\uAC1C\uB294 \uACF5\uBC31 \uC81C\uC678 15\uC790 \uC774\uC0C1\uC774\uC5B4\uC57C \uD569\uB2C8\uB2E4";
...
var replaceAllBlack = (value) => value.replace(/\s/g, "");
var checkStringLength = curry(
  (from, to, message, value) => value.trim().length >= from && value.length <= to ? Either.right(value) : Either.left(message)
);
var checkSpeicalCharacter = curry(
  (regex, message, value) => regex.test(value) ? Either.right(value) : Either.left(message)
);
var checkNicknameLength = checkStringLength(
  3,
  15,
  NICKNAME_LENGTH_ERROR_MESSAGE
);
var checkNicknameCharacter = checkSpeicalCharacter(
  REGEX_WITHOUT_CHARACTERS,
  NICKNAME_CHARACTER_ERROR_MESSAGE
);
var checkNicknameWhiteSpace = checkSpeicalCharacter(
  REGEX_CHECK_BLANK,
  NICKNAME_WHITESPACE_ERROR_MESSAGE
);
var checkValidEmail = checkSpeicalCharacter(
  REGEX_EMAIL,
  EMAIL_FORMAT_ERROR_MESSAGE
);
var checkPasswordHasUpperCase = checkSpeicalCharacter(
  REGEX_ALPHABET_UPPER_CASE,
  PASSWORD_FORMAT_ERROR_MESSAGE
);
var checkPasswordHasLowerCase = checkSpeicalCharacter(
  REGEX_ALPHABET_LOWER_CASE,
  PASSWORD_FORMAT_ERROR_MESSAGE
);
var checkPasswordHasSpecificCharacters = checkSpeicalCharacter(
  REGEX_SPECIFIC_CHARACTERS,
  PASSWORD_FORMAT_ERROR_MESSAGE
);
var checkPasswordLength = checkStringLength(
  10,
  20,
  PASSWORD_LENGTH_ERROR_MESSAGE
);
var checkTagCharacter = checkSpeicalCharacter(
  REGEX_TAG,
  TAG_CHARACTER_ERROR_MESSAGE
);
var checkIntroductionLength = pipe(
  replaceAllBlack,
  checkStringLength(
    15,
